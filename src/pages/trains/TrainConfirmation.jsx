...
import { CheckCircle, Train, Briefcase, Home } from 'lucide-react';

export default function TrainConfirmation() {
    ...
    return (
        <div className="min-h-screen bg-ivory pt-20 flex items-center justify-center px-4">
            <div className="max-w-lg w-full text-center animate-slide-up">
                ...
                <h1 className="text-3xl font-display font-bold text-charcoal mb-2">Train Booked! 🚆</h1>
                <p className="text-warmgray mb-8">Your train ticket is confirmed. Have a great journey!</p>
                {booking && (
                    <div className="card p-6 text-left mb-6">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2"><Train className="w-5 h-5 text-orange" /><span className="font-semibold">Train Booking</span></div>
                            <span className="tag-orange text-xs">CONFIRMED</span>
                        </div>
                        <div className="space-y-2 text-sm">
                            <div className="flex justify-between"><span className="text-warmgray">PNR</span><span className="font-bold tracking-widest">{booking.pnr}</span></div>
                            <div className="flex justify-between"><span className="text-warmgray">Booking ID</span><span>{booking.id}</span></div>
